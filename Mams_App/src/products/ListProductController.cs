...
public class ListProductController : ABaseController, IRefreshable
{
    ...
    /// <summary>
    /// Initializes a new instance of the ListProductController class.
    ...
    /// <summary>
    /// Navigates to the save page for creating a new product.
    /// </summary>
    ...
    /// <summary>
    /// Navigates to the save page for modifying the selected product.
    /// </summary>
    /// <param name="obj">Command parameter (not used).</param>
    ...
    private void deleteOrRestoreItem(object? obj)
    {
        if (_m_selected_item != null)
        {
            ...
            if (_m_is_show_archived_checked)
            {
                result = _m_item_model.deleteItem(_m_selected_item.product_id.ToString(), EDeleteItemOperation.RESTORE);
            }
            else
            {
                result = _m_item_model.deleteItem(_m_selected_item.product_id.ToString());
            }
