    ...
    ICrudOperation<ProductShapeItem>
{
    ...
    /// <summary>
    /// Determines whether a product shape can be permanently deleted or will be archived due to foreign key references.
    /// </summary>
    /// <param name="id">The unique identifier of the product shape to check.</param>
    /// <returns><see langword="true"/> if the product shape can be permanently deleted; 
