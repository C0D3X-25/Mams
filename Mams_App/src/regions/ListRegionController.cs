...
public class ListRegionController : ABaseController, IRefreshable
{
    ...
    private readonly RegionModel _m_item_model;
    ...
    private ObservableCollection<RegionItem>? _m_list_items;
    public ObservableCollection<RegionItem>? m_list_items
    {
    ...
    private RegionItem? _m_selected_item;
    public RegionItem? m_selected_item
    {
    ...
    /// <summary>
    /// Initializes a new instance of the ListRegionController class.
    ...
    private void updateListItems()
    {
        ...
        {
            m_list_items = new ObservableCollection<RegionItem>(
                all_items.Where(item => item.region_archive == string.Empty)
            );
    ...
    /// <summary>
    /// Navigates to the save page for creating a new region.
    /// </summary>
    /// <param name="obj">Command parameter (not used).</param>
    private void navigateToSavePage(object? obj)
    {
        SPageNavigationController.navigateTo(new SaveRegionPage());
    }
    ...
    /// <summary>
    /// Navigates to the save page for modifying the selected region.
    /// </summary>
    /// <param name="obj">Command parameter (not used).</param>
    public void navigateToModifyPage(object? obj)
    {
        ...
        {
            SPageNavigationController.navigateTo(new SaveRegionPage(_m_selected_item.region_id));
        }
    }
    ...
    private void deleteOrRestoreItem(object? obj)
    {
        if (_m_selected_item != null)
        {
            ...
            if (!_m_is_show_archived_checked)
            {
                result = _m_item_model.deleteItem(_m_selected_item.region_id.ToString());
            }
            else
            {
                result = _m_item_model.deleteItem(_m_selected_item.region_id.ToString(), EDeleteItemOperation.RESTORE);
            }
