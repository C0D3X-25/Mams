...
public class ReceiptHandlerModelTests
{
    [Fact]
    public void GetItemByID_InvalidId_ReturnsFailure()
    {
        // Arrange
        var model = new ReceiptHandlerModel();
    ...
    [Fact]
    public void DeleteItem_InvalidId_ReturnsFailure()
    {
        // Arrange
        var model = new ReceiptHandlerModel();

        // Act
        var response = model.deleteItem("invalid-id");
    ...
    [Fact]
    public void DeleteItem_EmptyId_ReturnsFailure()
    {
        // Arrange
        var model = new ReceiptHandlerModel();

        // Act
        var response = model.deleteItem(string.Empty);
    ...
    [Fact]
    public void DeleteItem_NullId_ReturnsFailure()
    {
        // Arrange
        var model = new ReceiptHandlerModel();

        // Act
        var response = model.deleteItem(null!);
    ...
    [Fact]
    public void DeleteItem_NegativeId_ReturnsFailure()
    {
        // Arrange
        var model = new ReceiptHandlerModel();

        // Act
        var response = model.deleteItem("-1");
